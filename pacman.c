...
int main(int argc, char *argv[100]) {
    ...
    // Create putput file to provide information
    FILE *fp;
    ...
    fprintf(fp, "Number of generated nodes: %d\n", generated_nodes);
    fprintf(fp, "Number of expanded nodes: %d\n", expanded_nodes);
    fprintf(fp, "Number of expanded nodes per second: %d\n", 
            expanded_nodes_ps);
    fprintf(fp, "Total search time: %d seconds\n", total_search_time);
    fprintf(fp, "Maximum value in the board: %d\n", max_board_value);
    fprintf(fp, "Score: %d\n", score);
